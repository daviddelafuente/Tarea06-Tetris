...
public class Tetris extends JFrame {
	...
	private int score;
        ...
        /**
         * La subíndice de la pieza actual
         */
        private int iPieza;
	...
	private float gameSpeed;
        ...
        /**
         * El nombre del archivo de texto que usará para guardar o cargar datos
         */
			...
			public void keyPressed(KeyEvent e) {
				...
				case KeyEvent.VK_ENTER:
					...
					break;
                                ...
                                /*
                                * Guardar Juego - Guardar la información del Juego
                                *
                                */
                                case KeyEvent.VK_G:
						...
						try {
                                                    ...
                                                    System.out.println("Error en " + d.toString());
                                                    }
					}
					break;
	...
	public int getPieceRotation() {
         ...
         * como puntaje, nivel y velocidad del juego
         * @throws IOException 
         */
         ...
         * @throws IOException 
         */
        public void guardarScore () throws IOException {
            // Creo el archivo de texto para guardar la información
            sNombreArchivo = "Score.txt";
        ...
        /**
         * guardarPiezas
         * Método que guarda el tipo de pieza que hay en cada Tile del tablero
         * @throws IOException 
         */
        public void guardarPiezas () throws IOException {   
            // Creo el archivo de texto para guardar la información
            sNombreArchivo = "Piezas.txt";
            PrintWriter fileOut = new PrintWriter(new FileWriter(sNombreArchivo));
            ...
            for(int i = 0; i < board.getRows(); i++) {
                for(int j = 0; j < board.getColumns(); j++) {
                    TileType tTile;
                    tTile = board.getTile(j, i);
                    
                    // Si está vacía, guarda -1, sino guarda el número de pieza
                    if(tTile == null) {
                        fileOut.println("-1");
                    } else {
                        int iTipo = tTile.getTipo();
                        fileOut.println(iTipo);
                    }
                }
            }
        ...
        /**
         * guardarPiezaActual
         * Método que guarda la pieza actual que el jugador controla
         * @throws IOException 
         */
        public void guardarPiezaActual () throws IOException { 
            // Creo el archivo de texto para guardar la información
            sNombreArchivo = "PiezaActual.txt";
            PrintWriter fileOut = new PrintWriter(new FileWriter(sNombreArchivo));
            
            // Guardo el tipo de pieza, su renglón, columna y rotación
         ...
         * cargarJuego
         * 
         * Función que carga los datos del juego de un archivo de texto
         */
         ...
         * Función que carga los datos del juego de un archivo de texto
         */
        public void cargarScore() throws IOException {
            ...
            // temporal para lectura del puntaje, nivel y velocidad
            String sDato;
            int iTemp;
            float fTemp;
         ...
         * cargarPiezas
         * 
         * Función que carga las Piezas del Tableto
         */
        public void cargarPiezas() throws IOException {
            // Para acceder a la información de las Piezas
            sNombreArchivo = "Piezas.txt";
            BufferedReader fileIn;
            ...
            // Creo la variable String para lectura de datos y la variable
            // temporal para lectura de las piezas
            String sDato;
            int iTemp;
            ...
            for(int i = 0; i < board.getRows(); i++) {
                for(int j = 0; j < board.getColumns(); j++) {
                    ...
                    // Leo la línea y la paso a un entero
                    sDato = fileIn.readLine();
                    iTemp = (Integer.parseInt(sDato));
                    
                    if(iTemp != -1) {
                        // Creo la tile dependiendo de su número Índice
                        TileType tTile;
                        tTile = TileType.values()[iTemp];
                    
                        // Pongo esa tile en el espacio correspondiente
                        board.setTile(j, i, tTile);
                    }
                }
            }
            // Cierro el archivo de texto
         ...
         * cargarPiezaActual
         * 
         * Método que carga la pieza actual con sus posiciones correspondientes
         * y la pieza siguiente
         */
        public void cargarPiezaActual() throws IOException {
            // Para acceder a la información de las Piezas
            sNombreArchivo = "PiezaActual.txt";
            BufferedReader fileIn;
            ...
            // Cargo los datos de la pieza actual
            sDato = fileIn.readLine();
            iTemp = (Integer.parseInt(sDato));
            TileType tTemp = TileType.values()[iTemp];
            currentType = tTemp;
            ...
            sDato = fileIn.readLine();
            iTemp = (Integer.parseInt(sDato));
            currentRotation = iTemp;
            
            // Cargo el tipo de la siguiente pieza
            sDato = fileIn.readLine();
            iTemp = (Integer.parseInt(sDato));
            tTemp = TileType.values()[iTemp];
            nextType = tTemp;
