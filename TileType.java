...
public enum TileType {
	 ...
	 * Piece TypeI.
	 */
	TypeI(new Color(BoardPanel.COLOR_MIN, BoardPanel.COLOR_MAX, BoardPanel.COLOR_MAX), 4, 4, 1, 0, new boolean[][] {
		{
	 ...
	 * Piece TypeJ.
	 */
	TypeJ(new Color(BoardPanel.COLOR_MIN, BoardPanel.COLOR_MIN, BoardPanel.COLOR_MAX), 3, 3, 2, 1, new boolean[][] {
		{
			true,	false,	false,
			true,	true,	true,
			false,	false,	false,
	 ...
	 * Piece TypeL.
	 */
	TypeL(new Color(BoardPanel.COLOR_MAX, 127, BoardPanel.COLOR_MIN), 3, 3, 2, 2, new boolean[][] {
		{
			false,	false,	true,
			true,	true,	true,
			false,	false,	false,
	 ...
	 * Piece TypeO.
	 */
	TypeO(new Color(BoardPanel.COLOR_MAX, BoardPanel.COLOR_MAX, BoardPanel.COLOR_MIN), 2, 2, 2, 3, new boolean[][] {
		{
			true,	true,
			true,	true,
		},
	 ...
	 * Piece TypeS.
	 */
	TypeS(new Color(BoardPanel.COLOR_MIN, BoardPanel.COLOR_MAX, BoardPanel.COLOR_MIN), 3, 3, 2, 4, new boolean[][] {
		{
			false,	true,	true,
			true,	true,	false,
			false,	false,	false,
	 ...
	 * Piece TypeT.
	 */
	TypeT(new Color(128, BoardPanel.COLOR_MIN, 128), 3, 3, 2, 5, new boolean[][] {
		{
			false,	true,	false,
			true,	true,	true,
			false,	false,	false,
	 ...
	 * Piece TypeZ.
	 */
	TypeZ(new Color(BoardPanel.COLOR_MAX, BoardPanel.COLOR_MIN, BoardPanel.COLOR_MIN), 3, 3, 2, 6, new boolean[][] {
		{
			true,	true,	false,
			false,	true,	true,
			false,	false,	false,
	 ...
	 * @param rows The number of rows.
         * @param cPieza El tipo de pieza
	 * @param tiles The tiles.
	 */
	private TileType(Color color, int dimension, int cols, int rows, int iIndex, boolean[][] tiles) {
	...
	public int getBottomInset(int rotation) {
         ...
         * getTipo
         * 
         * Método get para el tipo de pieza
         */
        public int getTipo() {
            return iIndex;
        }
         ...
         * setTipo
         *
         * Método set para el tipo de pieza
         */
        public void setTipo(int iPieza) {
            iIndex = iPieza;
        }
}
